      ...
      <div className="min-h-screen bg-background pb-20 mb-safe">
        <div className="max-w-2xl mx-auto px-6 py-8 space-y-6">
          ...
          <Card className="p-8 rounded-3xl shadow-wellness border-border/50 text-center space-y-4">
            <h2 className="text-2xl font-light text-foreground">No Exercise Plan</h2>
            <p className="text-muted-foreground">Your exercise plan couldn't be loaded. Please try refreshing or generating a new plan.</p>
